...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    navController = [[UINavigationController alloc] initWithRootViewController:tagsViewController];
    navController.navigationBar.tintColor = [UIColor darkGrayColor];
    [tabViews addObject:navController];
    ...
    navController = [[UINavigationController alloc] initWithRootViewController:peopleViewController];
    navController.navigationBar.tintColor = [UIColor darkGrayColor];
    [tabViews addObject:navController];
    
    self.tabController = [[UITabBarController alloc] init];
    
    // Set the views in the tabs
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PhotosPlus" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PhotosPlus.sqlite"];
