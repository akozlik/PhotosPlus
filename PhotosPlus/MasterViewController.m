...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[[NSSortDescriptor alloc] initWithKey:@"album" ascending:NO] autorelease];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[managedObject valueForKey:@"album"] description];
}
        ...
        for (UIView* view in alertView.subviews)
        {
            if ([view isKindOfClass:[UITextField class]])
            {
                ...
                if (textField != nil)
                {
                    ...
                    [newManagedObject setValue:textField.text forKey:@"album"];
